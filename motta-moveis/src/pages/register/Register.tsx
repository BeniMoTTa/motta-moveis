      ...
      <div className="max-w-[1440px] flex items-center flex-col justify-center pt-[20px] pb-[50px]">
        <div className="flex flex-col items-center justify-center w-[415px] maxsm:">
          ...
          <form className="w-full">
            ...
            <button className="w-full h-14 text-white mt-[20px] rounded-3xl flex justify-center items-center bg-gradient-to-r from-orange-400 to-red-500 gap-2 text-[21px] font-bold">
              Sign up
            </button>
